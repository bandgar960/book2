        ...
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            ...
            <img src={logo} alt="Book Store App" height="50px" />
               <strong>Book-Hub</strong>              
            </h6>
            <p>
            Book-Hub is an online React web application where the customer can purchase books online.
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="https://ecom-onlinestore.netlify.app/">Ecommerce Website</a>
            </p>
          </MDBCol>
